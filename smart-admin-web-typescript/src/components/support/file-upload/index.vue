...
<template>
  <div class="clearfix">
    <a-upload :multiple="props.multiple" :accept="props.accept" :before-upload="beforeUpload"
      :customRequest="customRequest" :file-list="fileList"
      :headers="{ Authorization: 'Bearer ' + useUserStore().getToken }" :list-type="listType" @change="handleChange"
